...
departments = {
    ...
    7: Department(7, "Clothes", [Product("Graphic T's", 20), Product("Kanye Sweater", 700), Product("Skechers High Tops", 50)]),
    15: Department(15, "Toys", [Product("Nerf Guns", 200), Product("Settlers of Catan", 40), Product("Nintendo Lego Set", 150), Product("Lightsaber", 200)])
}
